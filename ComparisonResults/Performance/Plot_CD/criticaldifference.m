...
if alpha == 0.01
%% Critical values for the two-tailed Bonferroni-Dunn test (Display_BD_CriticalValues.m)
qalpha = [0.000 2.576 2.807 2.935 3.023 3.090 3.144 3.189 3.227 3.261 ...
...
elseif alpha == 0.05
%% Critical values for the two-tailed Bonferroni-Dunn test (Display_BD_CriticalValues.m)
qalpha = [0.000 1.960 2.241 2.394 2.498 2.576 2.638 2.690 2.734 2.773 ...
